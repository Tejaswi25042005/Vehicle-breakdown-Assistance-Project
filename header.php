...
{               ?>
                                    <li> <p> <span> Contact: </span><?php  echo htmlentities($row->MobileNumber);?></p></li>
                                    <li> <p> <span> Email: </span><?php  echo htmlentities($row->Email);?></p></li><?php $cnt=$cnt+1;}} ?>
                                </ul>
                            </div>
                            <!-- welcome message end -->
                        </div>
                            ...
                            <div class="header-top-menu">
                                ...
                                <div class="top-social">
                                    <ul>
                                        ...
                                        <li><a href="driver/login.php">Mechanic</a></li>
                                    </ul>
                                </div>
                                <!-- top social end -->
